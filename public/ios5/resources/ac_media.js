...
var c=document.createElement("a"),h=document.createElement("span"),f=document.createElement("span"),b=document.createElement("span"),e=Media.options.downloadUrl||ac_media_language.downloadquicktimeurl||"https://web.archive.org/web/20111012190801/http://www.apple.com/quicktime/download/";
...
}if(null!==b&&(typeof b.codebase!=="undefined")&&""!==b.codebase){d=b.codeBase;}a.setAttribute("codebase","https://web.archive.org/web/20111012190801/http://www.apple.com/qtactivex/qtplugin.cab#version="+d);
...
}}else{this._videoId=null;}},videoID:function(){return this._videoId;},disableSizeSelector:false,disableFullscreenControl:false,expectingMovieJson:true,setSettingsControlsAvailableForLanguageAndPath:function(M,S){if(this.configSettings){var P=this.configSettings.metadata.captions,E=this.configSettings.metadata.sizes,R=this.configSettings.metadata.downloads,Q=this.configSettings.metadata.share||true,N=this.configSettings.metadata.lang,I=this.configSettings.metadata.title,F=this.configSettings.metadata.description,K=this.configSettings.src,O=this.configSettings.posterframe||"https://web.archive.org/web/20111012190801/http://images.apple.com/global/elements/overlay/overlay_movie_endstate_640x400_20081014.jpg";
...
/*
     FILE ARCHIVED ON 19:08:01 Oct 12, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:25:44 Jul 31, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 14.362
  LoadShardBlock: 78.68 (3)
  PetaboxLoader3.datanode: 133.079 (5)
  load_resource: 356.534 (2)
  PetaboxLoader3.resolve: 272.368 (2)
*/