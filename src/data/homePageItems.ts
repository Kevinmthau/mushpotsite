...
export const homePageItems: HomePageItem[] = [
  ...
  { type: 'div', src: '/images/wap_browser.jpg', alt: 'Openwave', size: 'large', extraSpacing: true },
  { type: 'div', src: '/images/smtp_pop3_server.gif', alt: 'Post.Office', extraSpacing: true },
