...
const PDF_VERSION = '2026-01-29';
const PDF_PATH = `/images/1040/documents/2026_0129 1040FifthAve9-10C ProposedArt.pdf?v=${PDF_VERSION}`;
const COVER_PATH = `/images/1040/documents/pdf-cover.webp?v=${PDF_VERSION}`;
